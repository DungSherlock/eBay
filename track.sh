...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl20 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"706890153"' ]]; then
#                 echo "'3272268059035" >> track-OrderID.txt
#                 echo jodyluck1@gmail.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl21 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"240828726"' ]]; then
#                 echo "'3242262040969" >> track-OrderID.txt
#                 echo joshrounsville@hotmail.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl23 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"680614474"' ]]; then
#                 echo "'3262264283538" >> track-OrderID.txt
#                 echo hdeluca365@gmail.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl24 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"226026281"' ]]; then
#                 echo "'3232260007864" >> track-OrderID.txt
#                 echo pearsontony89@yahoo.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl25 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"25776173"' ]]; then
#                 echo "'3272268960382" >> track-OrderID.txt
#                 echo madmadwilliams@icloud.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl27 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"50753947"' ]]; then
#                 echo "'3232260957971" >> track-OrderID.txt
#                 echo orv2485@gmail.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl29 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"689830322"' ]]; then
#                 echo "'3272267978726" >> track-OrderID.txt
#                 echo embs_62@yahoo.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl30 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"43966519"' ]]; then
#                 echo "'3272267981864" >> track-OrderID.txt
#                 echo robert.prodex@gmail.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl31 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"2625289"' ]]; then
#                 echo "'3232260809832" >> track-OrderID.txt
#                 echo mandy.brick@gmail.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl32 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"477200308"' ]]; then
#                 echo "'3282269991070" >> track-OrderID.txt
#                 echo sam.leIgh425@gmail.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl33 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"580231229"' ]]; then
#                 echo "'3242261579280" >> track-OrderID.txt
#                 echo baneen001@icloud.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl34 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"192991194"' ]]; then
#                 echo "'3272267079913" >> track-OrderID.txt
#                 echo patty4914@gmail.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl35 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"222411088"' ]]; then
#                 echo "'3262265318367" >> track-OrderID.txt
#                 echo wisedog99@gmail.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl36 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"240828726"' ]]; then
#                 echo "'3272268403030" >> track-OrderID.txt
#                 echo Jesus.carranza1@gmail.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl37 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"285333157"' ]]; then
#                 echo "'3272268359643" >> track-OrderID.txt
#                 echo papaswurf@gmail.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl38 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"824446116"' ]]; then
#                 echo "'3272267570902" >> track-OrderID.txt
#                 echo letIcIa.yanez19@gmail.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl39 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"941316836"' ]]; then
#                 echo "'3252263436757" >> track-OrderID.txt
#                 echo jodiedavis84@yahoo.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl41 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"430779192"' ]]; then
#                 echo "'3252263745177" >> track-OrderID.txt
#                 echo kelly.kalbes@gmail.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl44 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"10752553"' ]]; then
#                 echo "'3272267098195" >> track-OrderID.txt
#                 echo hancock.k@hotmail.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl45 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"294384508"' ]]; then
#                 echo "'3252263439025" >> track-OrderID.txt
#                 echo whitneystory1988@gmail.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl46 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"37532019"' ]]; then
#                 echo "'3272268107983" >> track-OrderID.txt
#                 echo hancock.k@hotmail.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl47 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"983999125"' ]]; then
#                 echo "'3262265042568" >> track-OrderID.txt
#                 echo rodneyr@2tab.io >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl48 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"666064683"' ]]; then
#                 echo "'3272269106749" >> track-OrderID.txt
#                 echo kgugs6388@gmail.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl49 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"171173804"' ]]; then
#                 echo "'3282269197550" >> track-OrderID.txt
#                 echo mason.jana@att.net >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl50 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"137359681"' ]]; then
#                 echo "'3282269091961" >> track-OrderID.txt
#                 echo babygronkh87@yahoo.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl54 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"420105378"' ]]; then
#                 echo "'3282269998397" >> track-OrderID.txt
#                 echo amanda_ward77@yahoo.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl55 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"526913580"' ]]; then
#                 echo "'3282200913405" >> track-OrderID.txt
#                 echo Rosario.m1523@gmail.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl56 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"689830322"' ]]; then
#                 echo "'3282269195053" >> track-OrderID.txt
#                 echo johIram@gmail.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl58 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"317661531"' ]]; then
#                 echo "'3282269784911" >> track-OrderID.txt
#                 echo ashley.mustard@gmail.com >> track-email.txt
...
#         for (( j=0; j<=4; j++))
#         do
#             if [[ `echo $curl60 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"55588974"' ]]; then
#                 echo "'3282269393499" >> track-OrderID.txt
#                 echo molly.butler67@gmail.com >> track-email.txt
