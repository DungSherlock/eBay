...
if [[ $curl70 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl70 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"480863972"' ]]; then
                echo "'3522245416238" >> track-OrderID.txt
                echo lindsey83w@yahoo.com >> track-email.txt
...
if [[ $curl71 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl71 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"14690469"' ]]; then
                echo "'3532246973385" >> track-OrderID.txt
                echo aurelis1207@hotmail.com >> track-email.txt
...
if [[ $curl72 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl72 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"630986668"' ]]; then
                echo "'3532246182646" >> track-OrderID.txt
                echo flowersmm@icloud.com >> track-email.txt
...
if [[ $curl73 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl73 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"680614474"' ]]; then
                echo "'3512243431002" >> track-OrderID.txt
                echo Roger.mcchesney.rm@gmail.com >> track-email.txt
...
if [[ $curl74 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl74 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"128265240"' ]]; then
                echo "'3522245924803" >> track-OrderID.txt
                echo pmata1108@gmail.com >> track-email.txt
...
if [[ $curl75 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl75 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"643320030"' ]]; then
                echo "'3512243223466" >> track-OrderID.txt
                echo Jacew9898@gmail.com >> track-email.txt
