...
if [[ $curl26 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl26 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"768720631"' ]]; then
                echo "'3962258743008" >> track-OrderID-ADOT.txt
                echo ADOT220501205848379 >> track-email-ADOT.txt
...
if [[ $curl29 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl29 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"269572873"' ]]; then
                echo "'3792223919942" >> track-OrderID-ADOT.txt
                echo ADOT220415052848263 >> track-email-ADOT.txt
...
if [[ $curl34 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl34 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"499036710"' ]]; then
                echo "'3902247670769" >> track-OrderID-ADOT.txt
                echo ADOT220428200348674 >> track-email-ADOT.txt
...
if [[ $curl35 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl35 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"680291077"' ]]; then
                echo "'3902247572204" >> track-OrderID-ADOT.txt
                echo ADOT220428224851122 >> track-email-ADOT.txt
...
if [[ $curl36 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl36 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"939529312"' ]]; then
                echo "'3902247297040" >> track-OrderID-ADOT.txt
                echo ADOT220428233417294 >> track-email-ADOT.txt
...
if [[ $curl37 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl37 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"152362616"' ]]; then
                echo "'3962258459889" >> track-OrderID-ADOT.txt
                echo ADOT220429063849578 >> track-email-ADOT.txt
...
if [[ $curl39 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl39 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"512892791"' ]]; then
                echo "'3912249836269" >> track-OrderID-ADOT.txt
                echo ADOT220430040849108 >> track-email-ADOT.txt
...
if [[ $curl40 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl40 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"17628848"' ]]; then
                echo "'3942254588633" >> track-OrderID-ADOT.txt
                echo ADOT220430040849109 >> track-email-ADOT.txt
...
if [[ $curl43 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl43 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"313546419"' ]]; then
                echo "'3942254568536" >> track-OrderID-ADOT.txt
                echo ADOT220501235848934 >> track-email-ADOT.txt
...
if [[ $curl44 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl44 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"348284886"' ]]; then
                echo "'3962258911403" >> track-OrderID-ADOT.txt
                echo ADOT220502013849605 >> track-email-ADOT.txt
...
if [[ $curl45 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl45 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"348284886"' ]]; then
                echo "'3942254086837" >> track-OrderID-ADOT.txt
                echo ADOT220503051352295 >> track-email-ADOT.txt
...
if [[ $curl46 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl46 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"348284886"' ]]; then
                echo "'3942254380473" >> track-OrderID-ADOT.txt
                echo ADOT220503053849104 >> track-email-ADOT.txt
...
if [[ $curl47 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl47 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"970197920"' ]]; then
                echo "'3942254879259" >> track-OrderID-ADOT.txt
                echo ADOT220428084351590 >> track-email-ADOT.txt
...
if [[ $curl48 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl48 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"285333157"' ]]; then
                echo "'3942254784218" >> track-OrderID-ADOT.txt
                echo ADOT220427044846875 >> track-email-ADOT.txt
...
if [[ $curl49 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl49 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"818068049"' ]]; then
                echo "'3952256908309" >> track-OrderID-ADOT.txt
                echo ADOT22050319285279 >> track-email-ADOT.txt
...
if [[ $curl50 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl50 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"37550884"' ]]; then
                echo "'3962258811968" >> track-OrderID-ADOT.txt
                echo ADOT220504034349387 >> track-email-ADOT.txt
...
if [[ $curl52 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl52 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"996906813"' ]]; then
                echo "'3952256675150" >> track-OrderID-ADOT.txt
                echo ADOT220427012847357 >> track-email-ADOT.txt
...
if [[ $curl53 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl53 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"112429682"' ]]; then
                echo "'3952256657078" >> track-OrderID-ADOT.txt
                echo ADOT220504084846411 >> track-email-ADOT.txt
...
if [[ $curl54 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl54 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"212029414"' ]]; then
                echo "'3952256257527" >> track-OrderID-ADOT.txt
                echo ADOT220502032847659 >> track-email-ADOT.txt
...
if [[ $curl55 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl55 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"837613230"' ]]; then
                echo "'3962258222233" >> track-OrderID-ADOT.txt
                echo ADOT220430234847592 >> track-email-ADOT.txt
...
if [[ $curl56 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl56 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"147929696"' ]]; then
                echo "'3962258009204" >> track-OrderID-ADOT.txt
                echo ADOT220501030345142 >> track-email-ADOT.txt
...
if [[ $curl57 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl57 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"290930472"' ]]; then
                echo "'3972260305135" >> track-OrderID-ADOT.txt
                echo ADOT220501043844678 >> track-email-ADOT.txt
...
if [[ $curl58 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl58 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"672388349"' ]]; then
                echo "'3952256588375" >> track-OrderID-ADOT.txt
                echo ADOT220501050844311 >> track-email-ADOT.txt
...
if [[ $curl59 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl59 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"168149882"' ]]; then
                echo "'3962258216320" >> track-OrderID-ADOT.txt
                echo ADOT220427123346288 >> track-email-ADOT.txt
...
if [[ $curl61 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl61 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"246674885"' ]]; then
                echo "'3952256182484" >> track-OrderID-ADOT.txt
                echo 1059DarrylHutchins102QuartermaineCtCaryNC275135152UShttpswwwwalmartcomipXERATHOutdoorCollapsibleFoldingUtilityWagonwithUniversal360AllTerrainWheelsforShoppingGardenParkPicnicandBeachCampingBlue246674885 >> track-email-ADOT.txt
...
if [[ $curl62 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl62 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"300578963"' ]]; then
                echo "'3952256583644" >> track-OrderID-ADOT.txt
                echo ADOT220425204845111 >> track-email-ADOT.txt
...
if [[ $curl63 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl63 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"377870589"' ]]; then
                echo "'3962258709795" >> track-OrderID-ADOT.txt
                echo ADOT220427001908682 >> track-email-ADOT.txt
...
if [[ $curl65 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl65 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"15042526"' ]]; then
                echo "'3972260619348" >> track-OrderID-ADOT.txt
                echo ADOT220502044348111 >> track-email-ADOT.txt
...
if [[ $curl66 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl66 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"56113342"' ]]; then
                echo "'3972260019196" >> track-OrderID-ADOT.txt
                echo ADOT220502071847663 >> track-email-ADOT.txt
...
if [[ $curl67 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl67 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"5606333"' ]]; then
                echo "'3972260820582" >> track-OrderID-ADOT.txt
                echo ADOT220503064346236 >> track-email-ADOT.txt
...
if [[ $curl68 =~ "error" ]]; then
    ...
    do
        for (( j=0; j<=4; j++))
        do
            if [[ `echo $curl68 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].productInfo.usItemId'` == '"608059902"' ]]; then
                echo "'3882241962208" >> track-OrderID-ADOT.txt
                echo 105213jamesFox2669GoshenChurchSouthRdBowlingGreenKY421039524UShttpswwwwalmartcomipZENSTYLE10x7ftPortableGolfNetHittingNetPracticeDrivingIndoorOutdoorwCarryBag608059902 >> track-email-ADOT.txt
