...
list=`curl -s 'https://on-graphql-gateway.on-running.com/' \
  ...
  -H 'x-access-token: eyJhbGciOiJIUzUxMiJ9.eyJ1c2VyX2lkIjoxNDQwOTM5LCJqdGkiOiJ2NEVYTHB0alBXcTc3YnVqWFlnbnZkZWUiLCJpYXQiOjE2ODQ0NTg2OTEsImV4cCI6MTY4NTY2ODI5MX0.uNUDYLnZsBqJSV5NnqOyvBfrsigJn3KfekIxP3pmkTATPXW1a0c9hbIBNKEIgO6R_f2L-DsoXDHE25CVX2qXpA' \
