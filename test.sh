#!/bin/bash
gitCommit=`echo e222384251d1e8530a8ea2aa89df1ec9e7e884b5`
...
curl -sS 'https://script.google.com/macros/s/AKfycbxvgB0cMGKRjx_sVCDTrrzTkT40YIeRPsBUp-1-e913NLyI8mUywjiaGDu9MDj9bChN/exec?Giá=gia&Tên=Dũng'