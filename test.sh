...
echo $curl1 | jq '.data.guestOrder.groups_2101[0].items[0].productInfo.usItemId'
...
#         echo $curl1 | jq '.data.guestOrder.groups_2101['${i[@]}'].items['${j[@]}'].product.usItemId' 
...
#         echo $curl1 | jq '.data.guestOrder.groups_2101['${i[@]}'].shipment.trackingNumber' 
#         echo $curl1 | jq '.data.guestOrder.groups_2101['${i[@]}'].shipment.trackingUrl' 
#         echo "1"
#         break
#       fi
#     done
